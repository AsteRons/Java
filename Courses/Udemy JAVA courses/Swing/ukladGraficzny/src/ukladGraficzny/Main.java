...
public class Main extends JFrame
{
	...
	public Main()
	{
		...
		this.setDefaultCloseOperation(3);	//parametr w czasie zamkniêcia
	}
	...
	public void initComponents()
	{
		...
		*/
		...
		centrum.setSize(centrum.getPreferredSize());	//getPreferredSize() - pobierz preferowan¹ wielkosæ
		kontener.setLayout(null);
		// null	-	usuniêcie menad¿era uk³¹dów graficznych, 
